...
//	}
	...
	function withIndexedDB(db) {
		...
		// ----------------------------------------
		// MAIN JS
		var mainJsDownload = fetchOrDownloadAndStore(db, Module.locateFile('https://rawcdn.githack.com/misha850/firstStrike/19a66da4b3f8435829e33e69016f78fbbf07b6bf/UE4Game-HTML5-Shipping.js'), 'blob').then(function(data) {
		...
		// ----------------------------------------
		// MORE JS
		var dataJsDownload = fetchOrDownloadAndStore(db, Module.locateFile('https://rawcdn.githack.com/misha850/firstStrike/19a66da4b3f8435829e33e69016f78fbbf07b6bf/FirstPerson-HTML5-Shipping.data.js'));
		var utilityJsDownload = fetchOrDownloadAndStore(db, Module.locateFile('https://rawcdn.githack.com/misha850/firstStrike/19a66da4b3f8435829e33e69016f78fbbf07b6bf/Utility.js')).then(addScriptToDom);
		var dataDownload =
